...
description: Industrial control-room visual identity (Deep Navy Desk) for SmartFactory Web Manager — DailyCheck compliance, TaskIncident command, and shop-floor chat.
colors:
  background: "#EEF2F6"
  foreground: "#1F2A37"
  card: "#FFFFFF"
  ...
  on-sidebar-accent: "#1E3A5F"
  sidebar-border: "#D0D8E2"
  sidebar-ring: "#1E3A5F"
typography:
  headline-lg:
    fontFamily: Roboto
